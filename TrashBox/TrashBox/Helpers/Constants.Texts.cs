...
3. Circles with pictures as description.";
            ...
            public const string ProgressBarsDescription = @"1. Gradient for background and progress.
2. Outer and inner CornerReadius.
3. Percentage text with StringFormat. Only for detailed bar.
4. PrimaryText (progress ≥ 50%) and SecondaryText (else) colors. Only for detailed bar.";
